...
describe("doHealthPing", () => {
  const MOCK_PING_DATA = {
    uri: [
      "https://not.a.real.host:3000/healthz-streamlit",
      "https://not.a.real.host:3001/healthz-streamlit",
    ],
    timeoutMs: 10,
    maxTimeoutMs: 100,
    retryCallback: () => {},
  ...
  it("calls retry with corresponding fragment when there is no response from localhost", async () => {
    const MOCK_PING_DATA_LOCALHOST = {
      ...MOCK_PING_DATA,
      uri: [
        "https://localhost:3000/healthz-streamlit",
        "https://localhost:3001/healthz-streamlit",
      ],
    }
